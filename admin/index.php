...
<?php include "includes/admin_navigation.php"; ?>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-red">
          ...
          <!-- Dashboard For Admin / Widget Finish-->
                <!-- /.row -->
...
$select_all_unnapp_comments = mysqli_query($connection,$query);
$unapp_comment_count = mysqli_num_rows($select_all_unnapp_comments);
...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
         ...
         $element_count = [$post_count, $post_published_count, $post_draft_count, $comment_counts, $unapp_comment_count, $user_counts, $subscriber_count, $categories_counts];
